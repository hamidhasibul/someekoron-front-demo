      ...
      <div class="row">
        ...
        <div class="sidebar-container-right">
          <div class="row border-bottom py-3 px-2 align-items-center">
            <div class="col-lg-12">
              <p class="mb-0 text-color fs-20">Journal Report</p>
            </div>
          </div>
          ...
          <div class="container my-3">
            <div class="row justify-content-center">
              <div class="col-lg-10 border shadow-sm py-4 print_view" id="printID">
                ...
                <p class="fs-14 text-center mb-0">Journal</p>
                ...
                <table class="table align-middle" v-for="item in filteredData" :key="item.id">
                  <thead>
                    <tr class="shadowItem">
                      <th colspan="4" class="border-0 fs-14">
                        On {{ formatDate(item.date) }} - {{ item.description }} ({{ item.type }} - {{ item.payID }})
                      </th>
                    </tr>
                    <tr class="thead-color border">
                      <th scope="col" class="border-0 fs-13 text-muted font-weight-600 ps-4">Date</th>

                      <th scope="col" class="border-0 fs-13 text-muted font-weight-600">Accounts Head</th>
                  ...
                  <tbody>
                    <tr class="shadowItem" v-for="entry in item.entries">
                      ...
                      <td class="border-0 fs-12">{{ entry.credit }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
