      ...
      <div class="row">
        ...
        <div class="sidebar-container-right">
          <div class="row border-bottom py-3 px-2 align-items-center">
            <div class="col-lg-12">
              <p class="mb-0 text-color fs-20">Completed Projects List</p>
            </div>
          </div>
          ...
          <div class="container my-3">
            <div class="row justify-content-center">
              <div class="col-lg-10 border shadow-sm py-4 print_view" id="printID">
                ...
                <p class="fs-14 text-center mb-0">Completed Projects</p>
...
export default {
  ...
  methods: {
    ...
    getProjectData() {
      fetch(`${process.env.VUE_APP_SERVER_URL}/getProjectData`, {
        ...
        .then((res) => res.json())
        .then((data) => {
          this.completedProjects = data.message.filter((item) => {
  ...
  computed: {
    ...mapState(["orgInfo"]),
    filteredData() {
      const { startDate, endDate, completedProjects } = this;

      return completedProjects.filter(({ sdate }) => {
