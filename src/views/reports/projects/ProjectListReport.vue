      ...
      <div class="row">
        ...
        <div class="sidebar-container-right">
          <div class="row border-bottom py-3 px-2 align-items-center">
            <div class="col-lg-12">
              <p class="mb-0 text-color fs-20">Project List Report</p>
            </div>
          </div>
                ...
                <table class="table align-middle">
                  <thead>
                    <tr class="thead-color border">
                      ...
                      <th scope="col" class="border-0 fs-13 text-muted font-weight-600" width="15%">Start Date</th>
                  ...
                  <tbody class="border-0">
                    <tr class="shadowItem" v-for="item in filteredData" :key="item.id">
                      ...
                      <td class="border-0 fs-12" width="10%">
...
export default {
  ...
  computed: {
    ...mapState(["orgInfo"]),
    filteredData() {
      const { startDate, endDate, allProjects } = this;

      return allProjects.filter(({ sdate }) => {
