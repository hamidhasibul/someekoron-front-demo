      ...
      <div class="row">
        ...
        <div class="sidebar-container-right">
          <div class="row border-bottom py-3 px-2 align-items-center">
            <div class="col-lg-12">
              <p class="mb-0 text-color fs-20">Total Incoming Transaction</p>
            </div>
          </div>
          ...
          <div class="container my-3">
            <div class="row justify-content-center">
              <div class="col-lg-10 border shadow-sm py-4 print_view" id="printID">
                ...
                <p class="fs-14 text-center mb-0">Total Incoming Transactions</p>
                ...
                <table class="table align-middle">
                  <thead>
                    <tr class="thead-color border">
                      ...
                      <th scope="col" class="border-0 fs-13 text-muted font-weight-600">Amount (+VAT)</th>
                    </tr>
                  </thead>
                  <tbody class="border-0">
                    ...
                    <tr class="thead-color border">
                      ...
                      <th scope="col" class="border-0 fs-13 text-muted font-weight-600 text-end">Total</th>
...
export default {
  ...
  methods: {
    ...
    getJournalData() {
      fetch(`${process.env.VUE_APP_SERVER_URL}/getPReceiptData`, {
        ...
        .then((res) => res.json())
        .then((data) => {
          this.totalIncomingData = data.message;
        })
  ...
  computed: {
    ...mapState(["orgInfo"]),
    filteredData() {
      const { startDate, endDate, totalIncomingData } = this;

      return totalIncomingData.filter(({ date }) => {
