      ...
      <div class="row">
        ...
        <div class="sidebar-container-right">
          <div class="row border-bottom py-3 px-2 align-items-center">
            <div class="col-lg-12">
              <p class="mb-0 text-color fs-20">Suppliers Total Due</p>
            </div>
          </div>
          ...
          <div class="container my-3">
            <div class="row justify-content-center">
              <div class="col-lg-10 border shadow-sm py-4 print_view" id="printID">
                ...
                <p class="fs-14 text-center mb-0">Suppliers Total Due</p>
                ...
                <table class="table">
                  <thead>
                    <tr class="thead-color border">
                      ...
                      <th scope="col" class="border-0 fs-13 tesxt-start text-muted font-weight-600" width="10%">
                        PO ID
                      </th>
                      <th scope="col" class="border-0 fs-13 text-start text-muted font-weight-600" width="13%">
                        Vendor Name
                      </th>
...
export default {
  ...
  computed: {
    ...mapState(["orgInfo"]),
    filteredData() {
      const { startDate, endDate, payable } = this;

      return payable.filter(({ cdate }) => {
