      ...
      <div class="row">
        ...
        <div class="sidebar-container-right">
          <div class="row border-bottom py-3 px-2 align-items-center">
            <div class="col-lg-12">
              <p class="mb-0 text-color fs-20">Project Expense Report</p>
            </div>
          </div>
          ...
          <div class="container my-3">
            <div class="row justify-content-center">
              <div class="col-lg-10 border shadow-sm py-4 print_view" id="printID">
                ...
                <p class="fs-14 text-center mb-0">Project Expenses</p>
...
export default {
  ...
  methods: {
    ...
    getExpenseData() {
      fetch(`${process.env.VUE_APP_SERVER_URL}/getExpenseData`, {
        ...
        .then((res) => res.json())
        .then((data) => {
          this.projectExpenses = data.message.filter((item) => {
            return item.exp_type === "Project";
          });
  ...
  computed: {
    ...mapState(["orgInfo"]),
    filteredData() {
      const { startDate, endDate, projectExpenses } = this;

      return projectExpenses.filter(({ cdate }) => {
